...
function cariMatrixKaryawan () {	
	...
	echo "<form method=\"post\" class=\"nice\" action=\"matrixkaryawan.php\">";
	echo "<select name=\"tahun\">";
	echo "<option>Tahun</option>\n";
	echo "<option value =\"2009\">2009</option>\n";
	echo "<option value =\"2010\">2010</option>\n";
	...
	echo "<option value=\"0,40\">Hal 1</option>\n";
	echo "<option value=\"40,40\">Hal 2</option>\n";
	echo "<option value=\"80,40\">Hal 3</option>\n";
	echo "<option value=\"120,40\">Hal 4</option>\n";
	echo "</select>\n";
