...
<body>
    ...
    if (isset($_POST['submit'])){
        ...
        $row = fetchDistinct("profile","where Jabatan='Dosen' AND Fak='$fakk' and idg='1' and status='1' order by sort asc","(Nama),(NamaLengkap),(Nip),(Jurusan)");
        //echo $jur;
        ...
        foreach($row as $r){
            $j++;
            //print_r($_jur);
            echo "<tr><td>$i</td><td>$r[NamaLengkap]</td><td>".jur_det($r[Jurusan])."</td>";
            /**
