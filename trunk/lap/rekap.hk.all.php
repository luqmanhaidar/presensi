...
if(isset($_POST['submit'])){
    ...
    $SQL= mysql_query("SELECT DISTINCT (NamaLengkap),(Nama),(Jurusan),(Gol) FROM profile WHERE Jabatan='Karyawan' AND Fak='$Fak' AND Jurusan <> 'PKL' AND status='1' ORDER BY Gol DESC");
    echo "<table>";
    ...
    echo "<tr><td><b>Unit Kerja Utama</b></td><td>: ".$Fak."</td></tr>";
    echo "</table>";
    ...
    while ($Res= mysql_fetch_assoc($SQL)){
        ...
        $absen    = $jml_hk-$ttlhadir-$ijin-$tugas-$sakit;
            echo "<td align=\"center\">".$ttlhadir."</td><td align=\"center\">".$ttltelat."</td><td align=\"center\">".$ttlplgawl."</td><td align=\"center\">".$tugas."</td><td align=\"center\">".$ijin."</td><td align=\"center\">".$sakit."</td>";
         if($absen < 0){
