...
if (isset($_POST['submit1'])){
	...
	if($hal=="all"){
	  $sql= "SELECT distinct(Nama),(NamaLengkap) FROM profile WHERE Jabatan='Karyawan' AND Fak='$fakk' ORDER BY sort ASC";
	}else{
	  $sql= "SELECT distinct(Nama),(NamaLengkap) FROM profile WHERE Jabatan='Karyawan' AND Fak='$fakk' ORDER BY sort ASC limit $hal";
	}
