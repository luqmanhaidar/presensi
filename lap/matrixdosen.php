...
if (isset($_POST['submit'])){
	...
	echo "<br />";
	$jur=fetchRow("adm_jurusan","where Fakultas='".$fakk."' AND JurId='$jur'");
	foreach($jur as $t) {
    ...
    foreach($sql as $user){
        $j++;
        $Row  = countRow("presensi","where login='".$user['Nama']."' AND date_format( presensi.Tanggal, '%m-%Y') = '$bt'  AND abs='1'","abs");
        $Row1 = countRow("presensi","where login='".$user['Nama']."' AND date_format( presensi.Tanggal, '%m-%Y') = '$bt'  AND abs='2'","abs");
        $Row2 = countRow("presensi","where login='".$user['Nama']."' AND date_format( presensi.Tanggal, '%m-%Y') = '$bt'  AND abs='5'","abs");
        $Row3 = countRow("presensi","where login='".$user['Nama']."' AND date_format( presensi.Tanggal, '%m-%Y') = '$bt'  AND abs='8'","abs");
