...
class CnnNav {
     ...
     */
	function CnnNav ($maxRows, $table, $strFieldSelect = "*", $tableId = "",$extQuery="", $numShow = "9", $interval = "5", $intervalShow = "3", $prev = "&laquo;prev", $next = "next&raquo;", $separator = " ", $css = "", $first = "&laquo;&laquo;", $last = "&raquo;&raquo;", $strOffset = "offset") {
